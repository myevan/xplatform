...
#cmakedefine ALTIVEC_GCC @ALTIVEC_GCC@

/* "Enable debug code features" */
#cmakedefine DEBUG @DEBUG@

/* PPC_ASM assembly found */
#cmakedefine GCC_PCC_ASM @GCC_PCC_ASM@

/* X86_64_ASM assembly found */
#cmakedefine GCC_X86_64_ASM @GCC_X86_64_ASM@

/* X86_ASM assembly found */
#cmakedefine GCC_X86_ASM @GCC_X86_ASM@
...
#cmakedefine HAVE_VARARGS_GLU_TESSCB @HAVE_VARARGS_GLU_TESSCB@

/* Define to 1 if you have the <windows.h> header file. */
#cmakedefine HAVE_WINDOWS_H @HAVE_WINDOWS_H@

/* Support Allegro API */
#cmakedefine ILUT_USE_ALLEGRO @ILUT_USE_ALLEGRO@

/* Support DirectX8 API */
#cmakedefine ILUT_USE_DIRECTX8 @ILUT_USE_DIRECTX8@

/* Support DirectX9 API */
#cmakedefine ILUT_USE_DIRECTX9 @ILUT_USE_DIRECTX9@

/* Define if system supports OpenGL API */
#cmakedefine ILUT_USE_OPENGL @ILUT_USE_OPENGL@

/* Support SDL API */
#cmakedefine ILUT_USE_SDL @ILUT_USE_SDL@

/* Support X11 API */
#cmakedefine ILUT_USE_X11 @ILUT_USE_X11@

/* Support X11 XRender extension */
#cmakedefine ILUT_USE_XRENDER @ILUT_USE_XRENDER@

/* Support X11 XShm extension */
#cmakedefine ILUT_USE_XSHM @ILUT_USE_XSHM@

/* Define if you want to build ILU part of DevIL (used in DevIL
   examples/tests) */
#cmakedefine ILU_ENABLED @ILU_ENABLED@

/* Define if you can support at least some ASM */
#cmakedefine IL_INLINE_ASM @IL_INLINE_ASM@

/* blp support (BLP is the texture format for Blizzard games.) */
#cmakedefine IL_NO_BLP @IL_NO_BLP@

/* bmp support (BMP is a standard Windows bitmap.) */
#cmakedefine IL_NO_BMP @IL_NO_BMP@

/* dcx support (DCX is a multi-page PCX file.) */
#cmakedefine IL_NO_DCX @IL_NO_DCX@

/* dds support (DDS (DirectDraw Surface) is used by DirectX to load images
   (usually DXTC).) */
#cmakedefine IL_NO_DDS @IL_NO_DDS@

/* dicom support (DICOM (Digital Imaging and Communications in Medicine) is
   used extensively in medical imaging.) */
#cmakedefine IL_NO_DICOM @IL_NO_DICOM@
...
#cmakedefine IL_NO_LIF @IL_NO_LIF@

/* mdl support (MDL is the format for models in the game Half-Life.) */
#cmakedefine IL_NO_MDL @IL_NO_MDL@
...
#cmakedefine IL_NO_TPL @IL_NO_TPL@
...
#cmakedefine IL_NO_WBMP @IL_NO_WBMP@
...
#cmakedefine IL_NO_XPM @IL_NO_XPM@
...
#cmakedefine IL_USE_JPEGLIB_UNMODIFIED @IL_USE_JPEGLIB_UNMODIFIED@
...
#cmakedefine MAX_OS_X @MAX_OS_X@

/* define if you have memalign memory allocation */
#cmakedefine MEMALIGN @MEMALIGN@

/* define if you have mm_malloc.h header */
#cmakedefine MM_MALLOC @MM_MALLOC@
...
#cmakedefine POSIX_MEMALIGN @POSIX_MEMALIGN@
